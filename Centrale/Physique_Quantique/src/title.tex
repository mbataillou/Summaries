...
{ \huge \bfseries Physique \\ Quantique $\&$ Statistique \\[0.4cm] }
\rule{\textwidth}{0.4pt}\vspace*{-\baselineskip}\vspace{3.2pt} % Thin horizontal line
\rule{\textwidth}{1.6pt}\\[1.5cm] % Thick horizontal line

\vfill

\includegraphics[scale=0.3]{./img/IM1.jpg} \\[1.5cm]
...
\begin{center}
  \url{https://github.com/mbataillou/Summaries/tree/master/Centrale/Physique_Quantique}
\end{center}
